...
var VendaService = /** @class */ (function () {
    ...
    VendaService.prototype.consultarVendaService = function (venda) {
        return this.http.get("https://cors-anywhere.herokuapp.com/https://stormy-badlands-29216.herokuapp.com/api/venda/consultar/" +
            venda);
    };
    VendaService.prototype.removerVendaService = function (venda) {
    ...
    VendaService.prototype.incluirVendaService = function (venda) {
    ...
    VendaService.prototype.alterarVendaService = function (venda) {
